...
public class Para extends DocBookElement {
	...
	// index
	// indexdiv
	validParentMap.put(InformalExample.getTag(), InformalExample.getAttributeMap());
	validParentMap.put(ItemizedList.getTag(), ItemizedList.getAttributeMap());
	...
	// refsection,
	validParentMap.put(RefSynopsisDiv.getTag(), RefSynopsisDiv.getAttributeMap());
	...
	validParentMap.put(VariableList.getTag(), VariableList.getAttributeMap());
