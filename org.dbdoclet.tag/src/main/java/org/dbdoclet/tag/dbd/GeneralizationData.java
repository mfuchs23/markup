 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: GeneralizationData.java,v 1.1.1.1 2004/12/21 14:00:26 mfuchs Exp $
...
public class GeneralizationData extends ProgramElement {
    ...
    public void setParentNode(int id) {
        setAttribute("parent", String.valueOf(id));
    }

    public void setChild(int id) {
        setAttribute("child", String.valueOf(id));
    }
}
