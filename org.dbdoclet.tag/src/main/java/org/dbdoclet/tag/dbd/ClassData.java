 ...
 * RCS Information:
 * ---------------
 * Id.........: $Id: ClassData.java,v 1.1.1.1 2004/12/21 14:00:25 mfuchs Exp $
...
public class ClassData extends ProgramElement {
    ...
    public void setInterface(boolean isInterface) {
        setAttribute("isInterface", String.valueOf(isInterface));
    }

    public void setException(boolean isException) {
        setAttribute("isException", String.valueOf(isException));
    }
}
