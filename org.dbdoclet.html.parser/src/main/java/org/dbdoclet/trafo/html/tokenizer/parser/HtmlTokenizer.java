...
public class HtmlTokenizer/*@bgen(jjtree)*/implements HtmlTokenizerTreeConstants, HtmlTokenizerConstants {/*@bgen(jjtree)*/
  ...
  public synchronized ArrayList < org.dbdoclet.trafo.html.tokenizer.Token > parse() throws ParseException
  {
    tokenList = new ArrayList < org.dbdoclet.trafo.html.tokenizer.Token > ();
    start();
    return tokenList;
  }
 ...
 /*@bgen(jjtree) tag */
  ...
  HashMap < String, String > attributeMap = new HashMap < String, String > ();
    try {
    org.dbdoclet.trafo.html.tokenizer.Token token = new org.dbdoclet.trafo.html.tokenizer.Token();
    tokenList.add(token);
 ...
 /*@bgen(jjtree) text */
  ...
  jjtree.openNodeScope(jjtn000);Token text;
    ...
    jjtree.closeNodeScope(jjtn000, true);
    jjtc000 = false;
    org.dbdoclet.trafo.html.tokenizer.Token token = new org.dbdoclet.trafo.html.tokenizer.Token(text.image);
        trace("text() " + token);
    tokenList.add(token);
    fireProgressEvent(token.toString());
    } finally {
